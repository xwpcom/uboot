...
uboot++.bin: $(objs)
	/opt/hisi-linux/x86-arm/arm-hisiv300-linux/bin/arm-hisiv300-linux-uclibcgnueabi-ld -static -nostartfiles -nodefaultlibs -nostdlib -Tleds.lds -o uboot++_elf $^
	/opt/hisi-linux/x86-arm/arm-hisiv300-linux/bin/arm-hisiv300-linux-uclibcgnueabi-objcopy -O binary -S uboot++_elf $@
	/opt/hisi-linux/x86-arm/arm-hisiv300-linux/bin/arm-hisiv300-linux-uclibcgnueabi-objdump -D -m arm uboot++_elf > uboot++.dis
...
clean:
	rm -f uboot++.bin uboot++_elf uboot++.dis *.o		
